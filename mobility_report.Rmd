...
# det kan vara att apple också byter siffran i "Dev43" varje dag
apple<-read.csv(paste0("https://covid19-static.cdn-apple.com/covid19-mobility-data/2008HotfixDev43/v3/en-us/applemobilitytrends-", date, ".csv"))
...
# APC data
apc = read_excel("01_input_data/Pastigande_per_vecka_trafikslag.xlsx", sheet = "Tabell_Vecka", range = "A3:D10000")
...
ggplot(subset(google2, sub_region_1 == "Uppsala County"), 
   ...
   labs(title = "Redande per vecka (Uppsala län)",
       caption = "Datakälla: Google",
       y = "Medel per vecka") +
  geom_line() +
  geom_hline(yintercept=0, linetype="dashed", 
